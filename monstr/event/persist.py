...
from monstr.db.db import Database, SQLiteDatabase, PostgresDatabase
...
class ClientSQLiteEventStore(SQLiteEventStore, ClientSQLEventStore,  ClientEventStoreInterface):
    ...
    """
        ...
        as its not required for the relay to support anything other than monstr filtered based queries
